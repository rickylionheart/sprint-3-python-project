...
for game in video_game_sales:
    ...
    # If the genre isn't a key yet, add it with the starting sales value
...
for game in video_game_sales:
    publisher = game[5]  # Publisher is at index 5
...
# Loop over items() to print each key-value pair on its own line
