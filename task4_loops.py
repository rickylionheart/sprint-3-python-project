...
for game in video_game_sales:
    if game[3] < 2000:
        pre_2000_count += 1  # Add exactly 1 for each game found

print(pre_2000_count)

total_north_sales = 0
total_Japan_sales = 0
for total_sales in video_game_sales:
    total_north_sales += total_sales[6]
    total_Japan_sales += total_sales[8]

  

print(total_north_sales)
print(total_Japan_sales)

if total_north_sales > total_Japan_sales:
